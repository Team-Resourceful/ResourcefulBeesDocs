...
The `feedItem` for a bee represents the item that is required to trigger the _**love**_ state for a bee. The item is a `string` value  in the form of `
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDU1MTE5MTgsLTE5OTI5NDU0MTgsLT
