...
Use `removeStingerOnAttack` when you want only a specific bee to either die or not die after stinging the player. The global config value `beeDiesFromSting
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTcyMTA0Mjk2LDE3ODU1OTE1NzFdfQ==
-->